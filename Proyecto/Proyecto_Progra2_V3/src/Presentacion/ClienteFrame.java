...
public class ClienteFrame extends javax.swing.JPanel {
    ...
    private TableModel MostrarListaCedula() {
        try {
            ...
            Logica logica = new Logica();
            List<Registro> lista = logica.ExtraerCedulaCliente(txtCedulaCliente.getText());
            Object[] columnas = new Object[]{"CedulaCliente", "CodigoCliente", "NombreCliente", "CedulaVendedor", "CodigoVendedor", "NombreVendedor", "Marca", "Descripcion", "Precio"};
            Object[][] datos = new Object[lista.size()][columnas.length];
    ...
    private TableModel MostrarListaCodigo() {
        try {
            ...
            Logica logica = new Logica();
            List<Registro> lista = logica.ExtraerCodigoCliente(txtCodigoCliente.getText());
            Object[] columnas = new Object[]{"CedulaCliente", "CodigoCliente", "NombreCliente", "CedulaVendedor", "CodigoVendedor", "NombreVendedor", "Marca", "Descripcion", "Precio"};
            Object[][] datos = new Object[lista.size()][columnas.length];
    ...
    private TableModel MostrarListaNombre() {
        try {
            ...
            Logica logica = new Logica();
            List<Registro> lista = logica.ExtraerNombreCliente(txtNombreCliente.getText());
            Object[] columnas = new Object[]{"CedulaCliente", "CodigoCliente", "NombreCliente", "CedulaVendedor", "CodigoVendedor", "NombreVendedor", "Marca", "Descripcion", "Precio"};
            Object[][] datos = new Object[lista.size()][columnas.length];
    ...
    private TableModel MostrarListaCedulaYCodigo() {
        try {
            ...
            Logica logica = new Logica();
            List<Registro> lista = logica.ExtraerCedulaYCodigoCliente(txtCedulaCliente.getText(), txtCodigoCliente.getText());
            Object[] columnas = new Object[]{"CedulaCliente", "CodigoCliente", "NombreCliente", "CedulaVendedor", "CodigoVendedor", "NombreVendedor", "Marca", "Descripcion", "Precio"};
            Object[][] datos = new Object[lista.size()][columnas.length];
    ...
    private TableModel MostrarListaCedulaYNombre() {
        try {
            ...
            Logica logica = new Logica();
            List<Registro> lista = logica.ExtraerCedulaYNombreCliente(txtCedulaCliente.getText(), txtNombreCliente.getText());
            Object[] columnas = new Object[]{"CedulaCliente", "CodigoCliente", "NombreCliente", "CedulaVendedor", "CodigoVendedor", "NombreVendedor", "Marca", "Descripcion", "Precio"};
            Object[][] datos = new Object[lista.size()][columnas.length];
    ...
    private TableModel MostrarListaCodigoYNombre() {
        try {
            ...
            Logica logica = new Logica();
            List<Registro> lista = logica.ExtraerCodigoYNombreCliente(txtCodigoCliente.getText(), txtNombreCliente.getText());
            Object[] columnas = new Object[]{"CedulaCliente", "CodigoCliente", "NombreCliente", "CedulaVendedor", "CodigoVendedor", "NombreVendedor", "Marca", "Descripcion", "Precio"};
            Object[][] datos = new Object[lista.size()][columnas.length];
    ...
    private TableModel MostrarListaCedulaYCodigoYNombre() {
        try {
            ...
            Logica logica = new Logica();
            List<Registro> lista = logica.ExtraerCedulaYCodigoYNombreCliente(txtCedulaCliente.getText(), txtCodigoCliente.getText(), txtNombreCliente.getText());
            Object[] columnas = new Object[]{"CedulaCliente", "CodigoCliente", "NombreCliente", "CedulaVendedor", "CodigoVendedor", "NombreVendedor", "Marca", "Descripcion", "Precio"};
            Object[][] datos = new Object[lista.size()][columnas.length];
    ...
    private void initComponents() {
        ...
        jLabel33.setText("Consultar Clientes");
    ...
    private void btnFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFiltrarActionPerformed
        if (txtCedulaCliente.getText().isEmpty() == false && txtCodigoCliente.getText().isEmpty() && txtNombreCliente.getText().isEmpty()) {
            this.ListaCedula();
        } else if (txtCodigoCliente.getText().isEmpty() == false && txtCedulaCliente.getText().isEmpty() && txtNombreCliente.getText().isEmpty()) {
            this.ListaCodigo();
        } else if (txtNombreCliente.getText().isEmpty() == false && txtCedulaCliente.getText().isEmpty() && txtCodigoCliente.getText().isEmpty()) {
            this.ListaNombre();
        } else if (txtCedulaCliente.getText().isEmpty() == false && txtCodigoCliente.getText().isEmpty() == false && txtNombreCliente.getText().isEmpty()) {
            this.ListaCedulaYCodigo();
        } else if (txtCedulaCliente.getText().isEmpty() == false && txtNombreCliente.getText().isEmpty() == false && txtCodigoCliente.getText().isEmpty()) {
            this.ListaCedulaYNombre();
        } else if (txtCodigoCliente.getText().isEmpty() == false && txtNombreCliente.getText().isEmpty() == false && txtCedulaCliente.getText().isEmpty()) {
            this.ListaCodigoYNombre();
        } else if (txtCedulaCliente.getText().isEmpty() == false && txtCodigoCliente.getText().isEmpty() == false && txtNombreCliente.getText().isEmpty() == false){
            this.ListaCedulaYCodigoYNombre();
        }else if (txtCedulaCliente.getText().isEmpty() && txtCodigoCliente.getText().isEmpty() && txtNombreCliente.getText().isEmpty()) {
